...
; Template to reference when adding new trainer parties
	; TrainerData:
	;	def_trainer_class TRAINER
	;	def_trainer 1
	;	tr_mon 50, RHYDON
	;		tr_nick "Nick"
	;		tr_moves ROCK_SLIDE, EARTHQUAKE, HORN_DRILL, SURF
	;	tr_mon 75, TAUROS
	;		tr_nick "The Bull"
	;		tr_moves BODY_SLAM, HYPER_BEAM, EARTHQUAKE, BLIZZARD
	;		tr_dvs 15 all	; Max DVs
	;		tr_stat_exp 65535 all ; Max Stat EXP
	;	end_trainer
...
; Viridian Gym
	def_trainer 3, TRAINERTYPE_MULTI_LEVELS
 	...
 	tr_mon 42, DUGTRIO
		tr_moves SLASH, SAND_ATTACK, FISSURE, EARTHQUAKE
 	tr_mon 44, NIDOQUEEN
		tr_moves EARTHQUAKE, TAIL_WHIP, THUNDER, DOUBLE_KICK
 	tr_mon 45, NIDOKING
		tr_moves EARTHQUAKE, LEER, THUNDER, DOUBLE_KICK
 	tr_mon 50, RHYDON
		tr_moves ROCK_SLIDE, FURY_ATTACK, FISSURE, EARTHQUAKE
	end_trainer
...
BrunoData:
 ...
 ErikaData:
 	...
 	tr_mon 29, VICTREEBEL
		tr_moves RAZOR_LEAF, SLEEP_POWDER, WRAP, ACID
 	tr_mon 24, TANGELA
		tr_moves CONSTRICT, BIND, MEGA_DRAIN, VINE_WHIP
 	tr_mon 29, VILEPLUME
		tr_moves PETAL_DANCE, STUN_SPORE, MEGA_DRAIN, ACID
 	end_trainer
 ...
 BlaineData:
 	...
 	def_trainer 1, TRAINERTYPE_MULTI_LEVELS
 	tr_mon 42, GROWLITHE
		tr_moves FLAMETHROWER, LEER, AGILITY, TAKE_DOWN
 	tr_mon 40, PONYTA
...
AgathaData:
	...
	def_trainer 1, TRAINERTYPE_MULTI_LEVELS
	tr_mon 56, GENGAR
		tr_moves CONFUSE_RAY, SUBSTITUTE, NIGHT_SHADE, MEGA_DRAIN
	tr_mon 56, GOLBAT
