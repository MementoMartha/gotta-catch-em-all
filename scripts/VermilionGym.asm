...
VermilionGymLTSurgeReceiveTM26Script:
	...
	call GiveItem
	jr nc, .bag_full
	ld a, TEXT_VERMILIONGYM_LT_SURGE_RECEIVED_TM26
	ldh [hTextID], a
	call DisplayTextID
	SetEvent EVENT_GOT_TM26
	jr .gym_victory
.bag_full
	ld a, TEXT_VERMILIONGYM_LT_SURGE_TM26_NO_ROOM
	ldh [hTextID], a
	call DisplayTextID
.gym_victory
...
VermilionGym_TextPointers:
	...
	dw_const VermilionGymLTSurgeReceivedTM26Text,     TEXT_VERMILIONGYM_LT_SURGE_RECEIVED_TM26
	dw_const VermilionGymLTSurgeTM26NoRoomText,       TEXT_VERMILIONGYM_LT_SURGE_TM26_NO_ROOM
...
VermilionGymLTSurgeText:
	...
	jr nz, .got_TM26_already
	call z, VermilionGymLTSurgeReceiveTM26Script
...
VermilionGymLTSurgeReceivedTM26Text:
	text_far _VermilionGymLTSurgeReceivedTM26Text
	sound_get_key_item
	text_far _TM26ExplanationText
	text_end

VermilionGymLTSurgeTM26NoRoomText:
	text_far _VermilionGymLTSurgeTM26NoRoomText
	text_end
